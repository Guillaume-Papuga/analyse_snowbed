...
P12013<-bef2013 
P12019<-bef2019 
P12019 <- subset(P12019, site %in% intersect(P12013$site, P12019$site))
P12013 <- subset(P12013, site %in% intersect(P12019$site, P12013$site))
P12019 = P12019[-2,]
...
col1 <-separate(col1,col=1,into = c("site","placette"), sep = "-") #site and plot group labels

tbi_201319P1$BCD.mat = cbind.data.frame(tbi_201319P1$BCD.mat, col1)
tbi_201319P1$BCD.mat$site = as.factor(tbi_201319P1$BCD.mat$site)
